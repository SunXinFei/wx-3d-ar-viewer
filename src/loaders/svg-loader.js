import { $DOMParser as DOMParser } from './DOMParser';
export function registerSVGLoader(THREE) {
  ...
  THREE.SVGLoader.pointsToStroke = function (points, style, arcDivisions, minDistance) {
    ...
    geometry.attributes.normal = new THREE.Float32BufferAttribute(normals, 3);
